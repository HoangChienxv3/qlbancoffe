...
public class DangNhapDialog extends javax.swing.JDialog {
    ...
    public void login() {
        ...
        tk.setMatKhau(new String(tpwPass.getPassword()));
        //System.out.println(tk.getMatKhau());//in ra mật khẩu
        int dn = DangNhapDao.DangNhap(tk);
        //System.out.println(dn);//kết quả xác định chế độ đăng nhập
        if (dn == 1) {
            lamMoiLoi();
            ...
            //sai tên đăng nhập
            lbLoiTenDangNhap.setText("Không tồn tại tài khoản");
            lbLoiMatKhau.setText("");
        } else {
            lamMoiLoi();
